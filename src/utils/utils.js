...
export const profileInfoTitle = profile.querySelector(".profile-info__title");
export const profileInfoSubtitle = profile.querySelector(".profile-info__subtitle");
...
export const formEditAvatar = popupEditAvatar.querySelector(".popup__form_type_edit-avatar");
